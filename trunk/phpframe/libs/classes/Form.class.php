...
class Form
{
    ...
    {
        return "<img id='$id' onclick='this.src=this.src+\"&\"+Math.random()' src='" . "index.php?m=admin&c=index&a=checkcode&time=" . rand(100000, 1000000) . "' style='width:".$width."px; height:".$height."px;'>";
    }
